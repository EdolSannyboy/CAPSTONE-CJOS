          ...
          <div class="col-md-3 col-sm-3 profile_left">
            <div class="profile_img text-center position-relative">
              <form id="updateProfilePicture" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="type" value="Canteen Staff">
                <input type="hidden" name="user_ID" value="<?= $row['user_id'] ?>">

                <div id="crop-avatar" class="position-relative d-inline-block">
                  <img id="imagePreview" class="img-responsive avatar-view img-fluid d-block m-auto rounded-circle border"  src="../assets/img/canteen-staff/<?= !empty($row['image']) ? $row['image'] : 'avatar.png' ?>" alt="Avatar"  style="width: 150px; height: 150px; object-fit: cover;" >
            ...
            <p class="text-center"><?= $user_type ?></p>
          ...
          <div class="col-md-9 col-sm-9 ">
            ...
            <div class="" role="tabpanel" data-example-id="togglable-tabs">
              <ul id="myTab" class="nav nav-tabs bar_tabs mb-5 py-0" role="tablist">
                <li role="presentation" class="active"><a href="#tab_content1" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true">Canteen Staff information</a></li>
              ...
              <div id="myTabContent" class="tab-content">
                ...
                <div role="tabpanel" class="tab-pane active" id="tab_content1" aria-labelledby="home-tab">
                  <form id="UpdateInformation" method="POST" autocomplete="off">
                    <input type="hidden" name="type" value="Canteen Staff">
                    <input type="hidden" name="user_ID" id="canteen_staff_ID" value="<?= $row['user_id'] ?>">
