<?php
  ...
  if (empty($row)) {
    $row = [
      ...
      'lastname'  => '',
      'image'     => 'avatar.png',
      'userlevel_name' => $user_type ?? 'Canteen Staff',
    ];
  }

  // Ensure $user_type label comes from userlevel_name in tbluser
  $user_type = $row['userlevel_name'] ?? $user_type;
  ...
  <div class="left_col scroll-view">
   ...
   <!--  <div class="profile clearfix">
      ...
      <div class="profile_info">
        ...
        <span class="d-none"><?= $user_type ?></span>
      </div>
    </div> -->
    <!-- /menu profile quick info -->
  ...
  <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
    <div class="menu_section">
        ...
        <ul class="nav side-menu mb-3">
          ...
          <li class="<?php echo ($current_page == 'create_orders.php') ? 'active' : ''; ?>">
  ...
  <div class="nav_menu">
      ...
      <ul class=" navbar-right">
        <li class="nav-item" style="padding-left: 15px;">
          <a href="items.php?filter=low_stock" class="nav-link position-relative" title="View low stock items">
            <i class="fa fa-bell"></i>
            <?php if ($low_stock_count > 0): ?>
              <span class="badge bg-warning" style="font-size: 0.7rem; position: absolute; top: -5px; right: -5px;">
                <?= $low_stock_count; ?>
              </span>
            <?php endif; ?>
          </a>
        ...
        <li class="nav-item dropdown open" style="padding-left: 15px;">
          <a href="javascript:;" class="user-profile dropdown-toggle" aria-haspopup="true" id="navbarDropdown" data-toggle="dropdown" aria-expanded="false">
            <img src="../assets/img/canteen-staff/<?= !empty($row['image']) ? $row['image'] : 'avatar.png' ?>" alt=""> Welcome, <?= ucwords($row['firstname']) ?>!
          </a>
