...
<title><?= $system_info['system_name'] ?> | Canteen Staff</title>
      ...
      <div class="x_content">
        ...
        <div class="modal fade" id="AddNew" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog">
            <form id="SaveForm" autocomplete="off" enctype="multipart/form-data">
              ...
              <input type="hidden" class="form-control" name="user_type" id="user_type" value="Canteen Staff" required>

              <div class="modal-content">
                <div class="modal-header bg-light">
                  <h5 class="modal-title" id="exampleModalLabel">New Canteen Staff</h5>
        ...
        <div class="modal fade" id="UpdateModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog">
            <form id="UpdateForm" autocomplete="off" enctype="multipart/form-data">
              ...
              <input type="hidden" class="form-control" name="user_type" id="edit_user_type" value="Canteen Staff"
                required>

              <div class="modal-content">
                <div class="modal-header bg-light">
                  <h5 class="modal-title" id="exampleModalLabel">Update Canteen Staff</h5>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="fa fa-times-circle"></i></span>
                  </button>
                </div>
        ...
        <div class="card-box bg-white table-responsive pb-2">
          ...
          <table id="datatable" class="table table-striped table-bordered table-hover" style="width:100%">
            ...
            <tbody>
              <?php
              $instructor = $db->getUsersByLevel(2, $id);
...
<script>
  $(document).ready(function () {
    ...
    $('#AddNew').on('hidden.bs.modal', function () {
      ...
      $('.birthdate-error-message').text('');
    });

    // Clear form fields when update modal is hidden
    ...
    $('#UpdateForm').submit(function (e) {
      ...
      $.ajax({
        ...
        success: function (response) {
          if (response.success) {
            showSweetAlert("Success!", response.message, "success", "canteen_staff_management.php"); //FORMAT: TITLE, TEXT, ICON, URL
          } else {
    ...
    $('#delete-selected').click(function () {
      var selectedIds = $('.select-record:checked').map(function () {
        return $(this).val();
      }).get();

      if (selectedIds.length === 0) {
        showSweetAlert("Warning", "Please select at least one record to delete.", "warning");
        return;
      }

      showSweetAlertWithConfirmation(
        "Are you sure?",
        ...
        function () {
          $.ajax({
            ...
            success: function (response) {
              if (response.success) {
                showSweetAlert("Success!", response.message, "success", "canteen_staff_management.php");
              } else {
            ...
            error: function (xhr, status, error) {
              console.error(xhr.responseText);
              showSweetAlert("Error", "An error occurred while processing your request.", "error");
            }
          });
        }
      );
