        ...
        <div class="row">
          <div class="col-lg-3">
            <ul class="nav nav-tabs flex-column">
              <li class="nav-item">
                <a class="nav-link active show" data-bs-toggle="tab" href="#specials-tab-1">Category here</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="#specials-tab-2">Category here</a>
              </li>
            </ul>
          </div>
          ...
          <div class="col-lg-8 d-flex align-items-center reservation-form-bg" data-aos="fade-up" data-aos-delay="200">
            <form action="forms/book-a-table.php" method="post" role="form" class="php-email-form">
              ...
              <div class="text-center mt-3">
                ...
                <?php if (isset($_SESSION['user_type']) && $_SESSION['user_type'] === 'Office Staff'): ?>
                  <button type="submit" class="BookATable">Book a Table</button>
                <?php else: ?>
                  <a class="cta-btn BookATable" href="login.php">Book a Table</a>
                <?php endif; ?>
              </div>
            </form>
          </div>
